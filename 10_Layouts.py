...
with st.container(border=True):
    ...
    st.write("Containers help mange sections of the page")

# Empty placeholder
placeholder = st.empty()
placeholder.write("This is an empty placeholder, usefull for dynamic elements")
...
st.button("button with Tooltip", help="This is a tooltip or popver on hover")
